...
#ifndef EUTELMIMOSA26DETECTOR_H
#define EUTELMIMOSA26DETECTOR_H
...
namespace eutelescope {
   ...
   *  @version $Id: EUTelMimosa26Detector.h 2285 2013-01-18 13:46:44Z hperrey $
   */
  ...
  public:
    //! Default constructor
    EUTelMimosa26Detector() ;

    //! Default destructor
    virtual ~EUTelMimosa26Detector() {;}
