// Version: $Id: EUTelMille.h 2898 2013-08-07 09:58:36Z hperrey $
/*
...
//       }
    ...
    virtual int guessSensorID( TrackerHit *hit );
  ...
  protected:
    ...
    IntVec _ClusterLimits;
    std::map<int, std::vector<int> > _ClusterLimitsMap;
    
    IntVec _TotLimits;
    std::map<int, std::map<int, std::vector<int> > > _TotLimitsMap;
