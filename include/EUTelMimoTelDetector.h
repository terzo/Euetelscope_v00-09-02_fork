...
#ifndef EUTELMIMOTELDETECTOR_H
#define EUTELMIMOTELDETECTOR_H
...
namespace eutelescope {
   ...
   *  @version $Id: EUTelMimoTelDetector.h 2285 2013-01-18 13:46:44Z hperrey $
   */
  ...
  public:
    //! Default constructor
    EUTelMimoTelDetector() ;

    //! Default destructor
    virtual ~EUTelMimoTelDetector() {;}
